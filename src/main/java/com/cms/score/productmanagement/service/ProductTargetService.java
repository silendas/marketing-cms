...
public class ProductTargetService {
    ...
    public ResponseEntity<Object> getProducts(int page, int size) {
        Page<ProductTarget> res = pagRepo.findAll(PageRequest.of(page, size));
        return Response.buildResponse(new GlobalDto(Message.SUCESSFULLY_DEFAULT.getStatusCode(), null, Message.SUCESSFULLY_DEFAULT.getMessage(), res.getContent(), res.getContent(), null), 1);
    }
    ...
    public ResponseEntity<Object> getProductTargetById(Long id) {
        ...
        if(!productTarget.isPresent()) {
            return Response.buildResponse(new GlobalDto(Message.NOT_FOUND_DEFAULT.getStatusCode(), null, Message.NOT_FOUND_DEFAULT.getMessage(), null, productTarget, null), 1);
        }
        return Response.buildResponse(new GlobalDto(Message.SUCESSFULLY_DEFAULT.getStatusCode(), null, Message.SUCESSFULLY_DEFAULT.getMessage(), null, productTarget, null), 1);
    }

    public ResponseEntity<Object> createProductTarget(ProductTarget productTarget) {
        return Response.buildResponse(new GlobalDto(Message.SUCESSFULLY_DEFAULT.getStatusCode(), null, Message.SUCESSFULLY_DEFAULT.getMessage(), null, repo.save(productTarget), null), 1);
    }

    public ResponseEntity<Object> updateProductTarget(Long id, ProductTarget productTarget) {
        return Response.buildResponse(new GlobalDto(Message.SUCESSFULLY_DEFAULT.getStatusCode(), null, Message.SUCESSFULLY_DEFAULT.getMessage(), null, getProductTarget(id), null), 1);
    }
    ...
    public ResponseEntity<Object> deleteProductTarget(Long id) {
        ...
        return Response.buildResponse(new GlobalDto(Message.SUCESSFULLY_DEFAULT.getStatusCode(), null, Message.SUCESSFULLY_DEFAULT.getMessage(), null, null, null), 0);
    }
